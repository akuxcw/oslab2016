...
init_segment(void) {
	...
	set_segment(&gdt[SEG_USER_CODE], DPL_USER, SEG_EXECUTABLE | SEG_READABLE, SEG_OFFSET, 0x80000);
	set_segment(&gdt[SEG_USER_DATA], DPL_USER, SEG_WRITABLE, SEG_OFFSET, 0x80000);
